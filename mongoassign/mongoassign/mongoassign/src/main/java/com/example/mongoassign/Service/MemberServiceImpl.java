...
public class MemberServiceImpl implements MemberService {
    ...
    public Member updateMember(Member member) {
        ...
        Member m2=m1.get();
        m2.setPersonId(member.getPersonId());
        m2.setFirstName(member.getFirstName());
        m2.setMiddleName(member.getMiddleName());
        m2.setLastName(member.getLastName());
        m2.setSuffix(member.getSuffix());
        m2.setDob(member.getDob());
        m2.setGender(member.getGender());
        m2.setHorizonEmployeeIndicator(member.gethorizonEmployeeIndicator());
